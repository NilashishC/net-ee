...
```bash
ansible-builder build --file net-ee.yaml --tag net-ee:latest --container-runtime podman
```
...
- **net-ee.yaml**: This is your EE's "blueprint." It's the main definition file that ansible-builder will use to construct your image.
- **net-ee-template.yaml**: This is the Ansible self-service automation portal template file that generated this. You can import it and use it as a base to create new templates for your portal.
...
```bash
# This command uses your 'net-ee.yaml' file to build an image
# and tags it as 'net-ee:latest'
...
```bash
ansible-navigator run playbook.yml --eei net-ee:latest --pull-policy missing
```
...
podman tag net-ee:latest your-pah-hostname/net-ee:latest

# Login to your Private Automation Hub
podman login your-pah-hostname

# Push the image
podman push your-pah-hostname/net-ee:latest
```
...
podman tag net-ee:latest your-internal-registry.com/net-ee:latest
podman login your-internal-registry.com
podman push your-internal-registry.com/net-ee:latest
```
...
If you want to reuse this execution environment template for future projects, you can import the generated **net-ee.yaml** file into your self-service automation portal.
...
2. **Import from Git repository**: Enter the Git SCM URL containing your `net-ee.yaml` file, click **Analyze** to validate, review the details, then click **Import**.
